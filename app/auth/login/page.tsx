    ...
    <div className="w-full max-w-[860px] rounded-2xl overflow-hidden shadow-2xl flex bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 py-10">
        <div className="max-w-sm w-full mx-auto">
          ...
          <h1 className="text-2xl font-extrabold text-slate-900 mb-7">Log into your account</h1>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" checked={rememberMe} onChange={e => setRememberMe(e.target.checked)}
                  className="w-4 h-4 accent-[#1D4ED8] rounded" />
                <span className="text-sm text-slate-600">Remember me</span>
              </label>
              <Link href="/auth/forgot-password" className="text-sm text-[#1D4ED8] font-semibold hover:underline">
                Forgot Password?
              </Link>
            </div>
