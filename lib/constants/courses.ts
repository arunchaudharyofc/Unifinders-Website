...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    shortName: "GRE",
    tagline: "Score 320+ for top graduate programs worldwide",
    category: "test-prep",
    description: "Comprehensive GRE prep covering Verbal Reasoning, Quantitative Reasoning, and Analytical Writing.",
    overview: "The GRE General Test is accepted by thousands of graduate schools worldwide. Our program uses adaptive strategies, timed drills, and expert coaching to help you score 320+ and secure admission to top MS, MBA, and PhD programs.",
    duration: "3 months",
    price: 20000,
    priceNote: "Includes official ETS prep materials & 10 mock tests",
    currency: "NPR",
    level: "Advanced",
    format: ["Online", "Offline"],
    accentColor: "#007AB8",
    features: [
      "320+ score strategies", "Adaptive practice drills", "Analytical Writing workshop",
      "1000+ quant problems", "Vocabulary building program", "Video solutions for every problem",
    ],
    highlights: [
      "450+ students trained", "Avg score improvement of 15 pts", "92% score 310+",
    ],
    syllabus: [
      { week: 1, topic: "Verbal Reasoning – Part 1", details: "Text completion, sentence equivalence, vocabulary building" },
      { week: 2, topic: "Verbal Reasoning – Part 2", details: "Reading comprehension, critical reasoning passages" },
      { week: 3, topic: "Quantitative – Arithmetic & Algebra", details: "Number properties, ratios, equations, inequalities" },
      { week: 4, topic: "Quantitative – Geometry & Data", details: "Coordinate geometry, probability, data interpretation" },
      { week: 5, topic: "Analytical Writing (AWA)", details: "Issue essay, Argument essay, scoring strategies" },
      { week: 6, topic: "Full Mock Tests & Review", details: "4 complete GRE mocks with section-wise analysis" },
    ],
    instructors: [
      { fullName: "Bikash Pandey", role: "GRE Expert — 10 years", bio: "Scored GRE 335. Has helped 450+ students get into Ivy League and top-50 universities." },
      { fullName: "Anita Basnet", role: "Verbal & AWA Coach", bio: "English literature PhD with expertise in GRE verbal strategies and analytical writing." },
    ],
    programs: [
      { name: "Weekend Batch", duration: "3 months", price: "NPR 20,000", format: "Offline" },
      { name: "Online Intensive", duration: "2 months", price: "NPR 16,000", format: "Online" },
      { name: "Self-Paced", duration: "4 months", price: "NPR 12,000", format: "Online" },
    ],
    resources: [
      { title: "Official ETS GRE Guide PDF", type: "PDF" },
      { title: "Barron's 1100 Words (GRE Vocab)", type: "PDF" },
      { title: "Quant Problem Set (1000+)", type: "Practice Test" },
      { title: "AWA Essay Templates", type: "PDF" },
    ],
    faqs: [
      { q: "What GRE score do I need for a top US university?", a: "Top-50 US universities typically look for GRE scores of 315+ overall, with 160+ in the relevant section (Quant for STEM, Verbal for humanities)." },
      { q: "How long are GRE scores valid?", a: "GRE scores are valid for 5 years from the test date." },
      { q: "Can I retake the GRE?", a: "Yes, you can take the GRE up to 5 times within any 12-month period, with a minimum of 21 days between attempts." },
    ],
    imageUrl: null,
    heroImage: null,
    icon: "📐",
  ...
  },
  {
    ...
    shortName: "OET",
    tagline: "English test designed exclusively for healthcare professionals",
    category: "test-prep",
    description: "OET preparation for nurses, doctors, dentists, and other healthcare professionals seeking to work or study abroad.",
    overview: "The Occupational English Test (OET) is specifically designed for healthcare professionals. It assesses English communication in a medical context and is accepted by healthcare regulators in Australia, UK, Ireland, New Zealand, Dubai, and Singapore.",
    duration: "6 weeks",
    price: 15000,
    priceNote: "Includes healthcare-specific practice materials",
    currency: "NPR",
    level: "Intermediate",
    format: ["Online", "Offline"],
    accentColor: "#1E5C3A",
    features: [
      "Healthcare-specific English", "Nursing & medical case studies", "Grade B guarantee program",
      "Role-play speaking practice", "Clinical letter writing", "Profession-specific mock tests",
    ],
    highlights: [
      "380+ healthcare professionals trained", "88% achieve Grade B", "Accepted in 6+ countries",
    ],
    syllabus: [
      { week: 1, topic: "Listening – Healthcare Contexts", details: "Patient consultations, health lectures, clinical discussions" },
      { week: 2, topic: "Reading – Medical Texts", details: "Healthcare articles, clinical protocols, research summaries" },
      { week: 3, topic: "Writing – Clinical Letters", details: "Referral letters, discharge summaries, transfer letters" },
      { week: 4, topic: "Speaking – Role Play", details: "Patient scenarios, breaking bad news, explaining procedures" },
      { week: 5, topic: "Profession-Specific Practice", details: "Nursing, medicine, dentistry, pharmacy scenarios" },
      { week: 6, topic: "Full Mock Tests", details: "3 complete OET mocks with detailed feedback" },
    ],
    instructors: [
      { fullName: "Dr. Sabina Gurung", role: "OET Specialist — 7 years", bio: "Registered nurse turned OET trainer. Has helped 380+ healthcare professionals achieve Grade B and secure registrations in Australia and UK." },
    ],
    programs: [
      { name: "Regular Batch", duration: "6 weeks", price: "NPR 15,000", format: "Offline" },
      { name: "Online Batch", duration: "8 weeks", price: "NPR 12,000", format: "Online" },
      { name: "Weekend Intensive", duration: "8 weeks", price: "NPR 15,000", format: "Offline" },
    ],
    resources: [
      { title: "OET Official Practice Test Book", type: "PDF" },
      { title: "Clinical Letter Templates (50+)", type: "PDF" },
      { title: "Speaking Role-Play Scenarios", type: "Video" },
    ],
    faqs: [
      { q: "Is OET accepted for Australian nursing registration?", a: "Yes, OET is accepted by the Nursing and Midwifery Board of Australia (NMBA) for nursing registration." },
      { q: "What grade do I need?", a: "Most healthcare regulators require a minimum of Grade B (350+) in each sub-test." },
      { q: "Which healthcare professions can take OET?", a: "OET is available for 12 healthcare professions including nursing, medicine, dentistry, pharmacy, physiotherapy, and more." },
    ],
    imageUrl: null,
    heroImage: null,
    icon: "🏥",
...
export const COURSE_INSTRUCTORS: CourseInstructorDetail[] = [
  ...
  },
  {
    id: "bikash-pandey",
    name: "Bikash Pandey",
    fullName: "Bikash Pandey",
    role: "GRE Expert — 10 years",
    avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&q=80",
    bio: "Scored GRE 335. Has helped 450+ students get into Ivy League and top-50 universities.",
    students: 450,
    rating: 4.8,
  },
  {
    id: "anita-basnet",
    name: "Anita Basnet",
    fullName: "Anita Basnet",
    role: "Verbal & AWA Coach",
    avatar: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=100&q=80",
    bio: "English literature PhD with expertise in GRE verbal strategies and analytical writing.",
    students: 350,
    rating: 4.7,
  },
  {
    ...
    fullName: "Dr. Sabina Gurung",
    role: "OET Specialist — 7 years",
    avatar: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=100&q=80",
    bio: "Registered nurse turned OET trainer. Has helped 380+ healthcare professionals achieve Grade B.",
    students: 380,
    rating: 4.7,
  },
];
